...
def text_files_to_builtin_modules(modules):
    out = []
    ...
    for module in modules:
        source = open(module['filename'])

        out.append('const char* BUILTIN_MODULE_'+module['name']+" = ")
    ...
    out.append("const char* find_builtin_module(const char* name) {")
    for module in modules:
        out.append('    if (strcmp(name, "' + module['name'] + '") == 0)')
        out.append('        return BUILTIN_MODULE_'+module['name']+';')
...
write_text_file('src/generated/stdlib_script_text.cpp',
        text_files_to_builtin_modules([
            ...
            {'name': "static_checking", 'filename':"src/ca/static_checking.ca"},
            {'name': "source_repro", 'filename':"src/ca/source_repro.ca"},
            {'name': "stack_dump", 'filename':"src/ca/stack_dump.ca"},
