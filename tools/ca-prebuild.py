...
def text_files_to_c_string(sourceFiles, variableName):
    out = []

    out.append("// This file was autogenerated from: "+str(sourceFiles))
    out.append("")
...
write_text_file('src/generated/stdlib_script_text.cpp',
        text_files_to_c_string(
            ["src/ca/stdlib.ca", "src/ca/code_change.ca"],
            "STDLIB_CA_TEXT"))
