...
{
    circa_set_native_ptr(circa_index(value, 0), context, ContextRelease);
}
...
void check_cairo_error(caStack* stack, cairo_t* context)
{
    cairo_status_t status = cairo_status(context);
    if (status != CAIRO_STATUS_SUCCESS) {
        circa_output_error(stack, cairo_status_to_string(status));
    }
}

void start_drawing(caStack* stack)
{
    cairo_surface_t* surface = as_cairo_surface(circa_input(stack, 0));
    cairo_t* context = cairo_create(surface);
    caValue* out = circa_set_default_output(stack, 0);
    circa_set_native_ptr(circa_index(out, 0), context, ContextRelease);
}

void Canvas_save(caStack* stack)
{
    cairo_t* context = as_cairo_context(circa_input(stack, 0));
    cairo_save(context);
}
void Canvas_restore(caStack* stack)
{
    cairo_t* context = as_cairo_context(circa_input(stack, 0));
...
void Canvas_stroke(caStack* stack)
{
    cairo_t* context = as_cairo_context(circa_input(stack, 0));
    cairo_stroke(context);
    check_cairo_error(stack, context);
}
void Canvas_fill(caStack* stack)
{
    cairo_t* context = as_cairo_context(circa_input(stack, 0));
    cairo_fill(context);
    check_cairo_error(stack, context);
}
void Canvas_paint(caStack* stack)
{
    cairo_t* context = as_cairo_context(circa_input(stack, 0));
    cairo_paint(context);
    check_cairo_error(stack, context);
}
void Canvas_clip(caStack* stack)
{
    cairo_t* context = as_cairo_context(circa_input(stack, 0));
    cairo_clip(context);
    check_cairo_error(stack, context);
}
void Canvas_clip_preserve(caStack* stack)
{
    cairo_t* context = as_cairo_context(circa_input(stack, 0));
...
void Canvas_reset_clip(caStack* stack)
{
    cairo_t* context = as_cairo_context(circa_input(stack, 0));
    cairo_reset_clip(context);
    circa_set_null(circa_output(stack, 0));
}
void Canvas_set_source_color(caStack* stack)
{
    cairo_t* context = as_cairo_context(circa_input(stack, 0));
...
void Canvas_fill_preserve(caStack* stack)
{
    cairo_t* context = as_cairo_context(circa_input(stack, 0));
    cairo_fill_preserve(context);
}
void Canvas_set_operator(caStack* stack)
{
    cairo_t* context = as_cairo_context(circa_input(stack, 0));
    cairo_set_operator(context, (cairo_operator_t) circa_int_input(stack, 1));
}

void Canvas__scale(caStack* stack)
{
    cairo_t* context = as_cairo_context(circa_input(stack, 0));
    float scaleX, scaleY;
    circa_vec2(circa_input(stack, 1), &scaleX, &scaleY);
    cairo_scale(context, scaleX, scaleY);
}

void Canvas__translate(caStack* stack)
{
    cairo_t* context = as_cairo_context(circa_input(stack, 0));
    float transformX, transformY;
    circa_vec2(circa_input(stack, 1), &transformX, &transformY);
    cairo_translate(context, transformX, transformY);
}

void Canvas_set_font_size(caStack* stack)
{
    cairo_t* context = as_cairo_context(circa_input(stack, 0));
    float size = circa_float_input(stack, 1);
...
void Canvas_text_extents(caStack* stack)
{
    cairo_t* context = as_cairo_context(circa_input(stack, 0));
...
void Canvas_font_extents(caStack* stack)
{
    cairo_t* context = as_cairo_context(circa_input(stack, 0));
...
void Canvas_get_current_point(caStack* stack)
{
    cairo_t* context = as_cairo_context(circa_input(stack, 0));
    double x,y;
    cairo_get_current_point(context, &x, &y);
    circa_set_vec2(circa_output(stack, 0), x, y);
    check_cairo_error(stack, context);
}

void Canvas_curve_to(caStack* stack)
{
    cairo_t* context = as_cairo_context(circa_input(stack, 0));
...
void Canvas_move_to(caStack* stack)
{
    cairo_t* context = as_cairo_context(circa_input(stack, 0));
    float x(0), y(0);
...
void Canvas_rel_move_to(caStack* stack)
{
    cairo_t* context = as_cairo_context(circa_input(stack, 0));
    float x(0), y(0);
    circa_vec2(circa_input(stack, 1), &x, &y);
...
void Canvas_rectangle(caStack* stack)
{
    cairo_t* context = as_cairo_context(circa_input(stack, 0));
...
void Canvas_line_to(caStack* stack)
{
    cairo_t* context = as_cairo_context(circa_input(stack, 0));
    float x(0), y(0);
    circa_vec2(circa_input(stack, 1), &x, &y);
...
void Canvas_rel_line_to(caStack* stack)
{
    cairo_t* context = as_cairo_context(circa_input(stack, 0));
    float x(0), y(0);
    circa_vec2(circa_input(stack, 1), &x, &y);
...
void Canvas_arc_negative(caStack* stack)
{
    cairo_t* context = as_cairo_context(circa_input(stack, 0));
    float center_x(0), center_y(0);
    circa_vec2(circa_input(stack, 1), &center_x, &center_y);
...
void Canvas_new_sub_path(caStack* stack)
{
    cairo_t* context = as_cairo_context(circa_input(stack, 0));
    cairo_new_sub_path(context);
}
void Canvas_close_path(caStack* stack)
{
    cairo_t* context = as_cairo_context(circa_input(stack, 0));
    cairo_close_path(context);
}
void Canvas_set_line_width(caStack* stack)
{
    cairo_t* context = as_cairo_context(circa_input(stack, 0));
    cairo_set_line_width(context, circa_to_float(circa_input(stack, 1)));
    circa_set_null(circa_output(stack, 0));
}
void Canvas_set_source_surface(caStack* stack)
{
    cairo_t* context = as_cairo_context(circa_input(stack, 0));
    cairo_surface_t* surface = as_cairo_surface(circa_input(stack, 1));
    float originX(0), originY(0);
    circa_vec2(circa_input(stack, 2), &originX, &originY);
...
void load_image(caStack* stack)
{
    ...
    circa_read_file_with_stack(stack, filename, &pngReadContext.contents);
    ...
    cairo_status_t status = cairo_surface_status(surface);
    if (status != CAIRO_STATUS_SUCCESS)
        return circa_output_error(stack, cairo_status_to_string(status));
...
void Surface__write_to_png(caStack* stack)
{
    cairo_surface_t* surface = as_cairo_surface(circa_input(stack, 0));
...
void Surface__size(caStack* stack)
{
    cairo_surface_t* surface = as_cairo_surface(circa_input(stack, 0));
    double x1, x2, y1, y2;
    ...
    circa_set_vec2(circa_output(stack, 0), x2 - x1, y2 - y1);
}

void Surface__image_blob(caStack* stack)
{
    caValue* surfaceVal = circa_input(stack, 0);
