...
const int name_FirstStatIndex = 123;
const int stat_TermsCreated = 124;
const int stat_TermPropAdded = 125;
const int stat_TermPropAccess = 126;
const int stat_Copy_PushedInputNewFrame = 127;
const int stat_Copy_PushedInputMultiNewFrame = 128;
const int stat_Copy_PushFrameWithInputs = 129;
const int stat_Copy_ListDuplicate = 130;
const int stat_Copy_LoopCopyRebound = 131;
const int stat_Cast_ListCastElement = 132;
const int stat_Cast_PushFrameWithInputs = 133;
const int stat_Cast_FinishFrame = 134;
const int stat_Touch_ListCast = 135;
const int stat_ValueCreates = 136;
const int stat_ValueCopies = 137;
const int stat_ValueCast = 138;
const int stat_ValueCastDispatched = 139;
const int stat_ValueTouch = 140;
const int stat_ListsCreated = 141;
const int stat_ListsGrown = 142;
const int stat_ListSoftCopy = 143;
const int stat_ListHardCopy = 144;
const int stat_DictHardCopy = 145;
const int stat_StringCreate = 146;
const int stat_StringDuplicate = 147;
const int stat_StringResizeInPlace = 148;
const int stat_StringResizeCreate = 149;
const int stat_StringSoftCopy = 150;
const int stat_StringToStd = 151;
const int stat_StepInterpreter = 152;
const int stat_InterpreterCastOutputFromFinishedFrame = 153;
const int stat_BranchNameLookups = 154;
const int stat_PushFrame = 155;
const int stat_LoopFinishIteration = 156;
const int stat_LoopWriteOutput = 157;
const int stat_WriteTermBytecode = 158;
const int stat_DynamicCall = 159;
const int stat_FinishDynamicCall = 160;
const int stat_DynamicMethodCall = 161;
const int stat_SetIndex = 162;
const int stat_SetField = 163;
const int name_LastStatIndex = 164;
const int name_LastBuiltinName = 165;
