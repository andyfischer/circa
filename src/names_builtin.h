...
const int stat_Cast_ListCast = 119;
const int stat_Cast_PushFrameWithInputs = 120;
const int stat_Cast_FinishFrame = 121;
const int stat_ValueCreates = 122;
const int stat_ValueCopies = 123;
const int stat_ValueCasts = 124;
const int stat_ValueTouch = 125;
const int stat_ListsCreated = 126;
const int stat_ListsGrown = 127;
const int stat_ListSoftCopy = 128;
const int stat_ListHardCopy = 129;
const int stat_DictHardCopy = 130;
const int stat_StringCreate = 131;
const int stat_StringDuplicate = 132;
const int stat_StringResizeInPlace = 133;
const int stat_StringResizeCreate = 134;
const int stat_StringSoftCopy = 135;
const int stat_StringToStd = 136;
const int stat_StepInterpreter = 137;
const int stat_InterpreterCastOutputFromFinishedFrame = 138;
const int stat_BranchNameLookups = 139;
const int stat_FramesCreated = 140;
const int stat_LoopFinishIteration = 141;
const int stat_GetTermEvalMetadata = 142;
const int stat_DynamicCall = 143;
const int stat_SetIndex = 144;
const int stat_SetField = 145;
const int name_LastStatIndex = 146;
const int name_LastBuiltinName = 147;
