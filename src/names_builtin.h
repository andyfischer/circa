...
const int op_DynamicMethodCall = 169;
const int op_ClosureCall = 170;
const int op_ClosureApply = 171;
const int op_FireNative = 172;
const int op_CaseBlock = 173;
const int op_ForLoop = 174;
const int op_ExitPoint = 175;
const int op_Return = 176;
const int op_Continue = 177;
const int op_Break = 178;
const int op_Discard = 179;
const int op_FinishFrame = 180;
const int op_FinishLoop = 181;
const int op_ErrorNotEnoughInputs = 182;
const int op_ErrorTooManyInputs = 183;
const int sym_LoopProduceOutput = 184;
const int sym_FlatOutputs = 185;
const int sym_OutputsToList = 186;
const int sym_Multiple = 187;
const int sym_Cast = 188;
const int sym_DynamicMethodOutput = 189;
const int sym_FirstStatIndex = 190;
const int stat_TermsCreated = 191;
const int stat_TermPropAdded = 192;
const int stat_TermPropAccess = 193;
const int stat_InternedNameLookup = 194;
const int stat_InternedNameCreate = 195;
const int stat_Copy_PushedInputNewFrame = 196;
const int stat_Copy_PushedInputMultiNewFrame = 197;
const int stat_Copy_PushFrameWithInputs = 198;
const int stat_Copy_ListDuplicate = 199;
const int stat_Copy_LoopCopyRebound = 200;
const int stat_Cast_ListCastElement = 201;
const int stat_Cast_PushFrameWithInputs = 202;
const int stat_Cast_FinishFrame = 203;
const int stat_Touch_ListCast = 204;
const int stat_ValueCreates = 205;
const int stat_ValueCopies = 206;
const int stat_ValueCast = 207;
const int stat_ValueCastDispatched = 208;
const int stat_ValueTouch = 209;
const int stat_ListsCreated = 210;
const int stat_ListsGrown = 211;
const int stat_ListSoftCopy = 212;
const int stat_ListHardCopy = 213;
const int stat_DictHardCopy = 214;
const int stat_StringCreate = 215;
const int stat_StringDuplicate = 216;
const int stat_StringResizeInPlace = 217;
const int stat_StringResizeCreate = 218;
const int stat_StringSoftCopy = 219;
const int stat_StringToStd = 220;
const int stat_StepInterpreter = 221;
const int stat_InterpreterCastOutputFromFinishedFrame = 222;
const int stat_BlockNameLookups = 223;
const int stat_PushFrame = 224;
const int stat_LoopFinishIteration = 225;
const int stat_LoopWriteOutput = 226;
const int stat_WriteTermBytecode = 227;
const int stat_DynamicCall = 228;
const int stat_FinishDynamicCall = 229;
const int stat_DynamicMethodCall = 230;
const int stat_SetIndex = 231;
const int stat_SetField = 232;
const int sym_LastStatIndex = 233;
const int sym_LastBuiltinName = 234;
