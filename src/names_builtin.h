...
const int stat_ListsCreated = 366;
const int stat_ListsGrown = 367;
const int stat_ListSoftCopy = 368;
const int stat_ListDuplicate = 369;
const int stat_ListDuplicate_100Count = 370;
const int stat_ListDuplicate_ElementCopy = 371;
const int stat_ListCast_Touch = 372;
const int stat_ListCast_CastElement = 373;
const int stat_HashtableDuplicate = 374;
const int stat_HashtableDuplicate_Copy = 375;
const int stat_StringCreate = 376;
const int stat_StringDuplicate = 377;
const int stat_StringResizeInPlace = 378;
const int stat_StringResizeCreate = 379;
const int stat_StringSoftCopy = 380;
const int stat_StringToStd = 381;
const int stat_DynamicCall = 382;
const int stat_FinishDynamicCall = 383;
const int stat_DynamicMethodCall = 384;
const int stat_SetIndex = 385;
const int stat_SetField = 386;
const int stat_SetWithSelector_Touch_List = 387;
const int stat_SetWithSelector_Touch_Hashtable = 388;
const int stat_StackPushFrame = 389;
const int s_LastStatIndex = 390;
const int s_LastBuiltinName = 391;
