...
const int op_ErrorNotEnoughInputs = 120;
const int op_ErrorTooManyInputs = 121;
...
const int stat_Copy_LoopCopyRebound = 130;
const int stat_Cast_ListCastElement = 131;
const int stat_Cast_PushFrameWithInputs = 132;
const int stat_Cast_FinishFrame = 133;
const int stat_Touch_ListCast = 134;
const int stat_ValueCreates = 135;
const int stat_ValueCopies = 136;
const int stat_ValueCast = 137;
const int stat_ValueCastDispatched = 138;
const int stat_ValueTouch = 139;
const int stat_ListsCreated = 140;
const int stat_ListsGrown = 141;
const int stat_ListSoftCopy = 142;
const int stat_ListHardCopy = 143;
const int stat_DictHardCopy = 144;
const int stat_StringCreate = 145;
const int stat_StringDuplicate = 146;
const int stat_StringResizeInPlace = 147;
const int stat_StringResizeCreate = 148;
const int stat_StringSoftCopy = 149;
const int stat_StringToStd = 150;
const int stat_StepInterpreter = 151;
const int stat_InterpreterCastOutputFromFinishedFrame = 152;
const int stat_BranchNameLookups = 153;
const int stat_PushFrame = 154;
const int stat_LoopFinishIteration = 155;
const int stat_LoopWriteOutput = 156;
const int stat_WriteTermBytecode = 157;
const int stat_DynamicCall = 158;
const int stat_FinishDynamicCall = 159;
const int stat_DynamicMethodCall = 160;
const int stat_SetIndex = 161;
const int stat_SetField = 162;
const int name_LastStatIndex = 163;
const int name_LastBuiltinName = 164;
