...
const int name_FirstStatIndex = 111;
const int stat_TermsCreated = 112;
const int stat_TermPropAdded = 113;
const int stat_TermPropAccess = 114;
const int stat_Copy_PushedInputNewFrame = 115;
const int stat_Copy_PushedInputMultiNewFrame = 116;
const int stat_Copy_PushFrameWithInputs = 117;
const int stat_Copy_ListDuplicate = 118;
const int stat_Copy_LoopCopyRebound = 119;
const int stat_Cast_ListCastElement = 120;
const int stat_Cast_PushFrameWithInputs = 121;
const int stat_Cast_FinishFrame = 122;
const int stat_Touch_ListCast = 123;
const int stat_ValueCreates = 124;
const int stat_ValueCopies = 125;
const int stat_ValueCast = 126;
const int stat_ValueCastDispatched = 127;
const int stat_ValueTouch = 128;
const int stat_ListsCreated = 129;
const int stat_ListsGrown = 130;
const int stat_ListSoftCopy = 131;
const int stat_ListHardCopy = 132;
const int stat_DictHardCopy = 133;
const int stat_StringCreate = 134;
const int stat_StringDuplicate = 135;
const int stat_StringResizeInPlace = 136;
const int stat_StringResizeCreate = 137;
const int stat_StringSoftCopy = 138;
const int stat_StringToStd = 139;
const int stat_StepInterpreter = 140;
const int stat_InterpreterCastOutputFromFinishedFrame = 141;
const int stat_BranchNameLookups = 142;
const int stat_PushFrame = 143;
const int stat_LoopFinishIteration = 144;
const int stat_LoopWriteOutput = 145;
const int stat_WriteTermBytecode = 146;
const int stat_DynamicCall = 147;
const int stat_FinishDynamicCall = 148;
const int stat_DynamicMethodCall = 149;
