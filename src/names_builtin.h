...
const int stat_InternedNameLookup = 128;
const int stat_InternedNameCreate = 129;
const int stat_Copy_PushedInputNewFrame = 130;
const int stat_Copy_PushedInputMultiNewFrame = 131;
const int stat_Copy_PushFrameWithInputs = 132;
const int stat_Copy_ListDuplicate = 133;
const int stat_Copy_LoopCopyRebound = 134;
const int stat_Cast_ListCastElement = 135;
const int stat_Cast_PushFrameWithInputs = 136;
const int stat_Cast_FinishFrame = 137;
const int stat_Touch_ListCast = 138;
const int stat_ValueCreates = 139;
const int stat_ValueCopies = 140;
const int stat_ValueCast = 141;
const int stat_ValueCastDispatched = 142;
const int stat_ValueTouch = 143;
const int stat_ListsCreated = 144;
const int stat_ListsGrown = 145;
const int stat_ListSoftCopy = 146;
const int stat_ListHardCopy = 147;
const int stat_DictHardCopy = 148;
const int stat_StringCreate = 149;
const int stat_StringDuplicate = 150;
const int stat_StringResizeInPlace = 151;
const int stat_StringResizeCreate = 152;
const int stat_StringSoftCopy = 153;
const int stat_StringToStd = 154;
const int stat_StepInterpreter = 155;
const int stat_InterpreterCastOutputFromFinishedFrame = 156;
const int stat_BranchNameLookups = 157;
const int stat_PushFrame = 158;
const int stat_LoopFinishIteration = 159;
const int stat_LoopWriteOutput = 160;
const int stat_WriteTermBytecode = 161;
const int stat_DynamicCall = 162;
const int stat_FinishDynamicCall = 163;
const int stat_DynamicMethodCall = 164;
const int stat_SetIndex = 165;
const int stat_SetField = 166;
const int name_LastStatIndex = 167;
const int name_LastBuiltinName = 168;
