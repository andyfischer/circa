...
const int op_ExitPoint = 119;
const int op_FinishFrame = 120;
const int op_FinishLoop = 121;
const int op_ErrorNotEnoughInputs = 122;
const int op_ErrorTooManyInputs = 123;
const int op_LoopProduceOutput = 124;
const int name_FirstStatIndex = 125;
const int stat_TermsCreated = 126;
const int stat_TermPropAdded = 127;
const int stat_TermPropAccess = 128;
const int stat_InternedNameLookup = 129;
const int stat_InternedNameCreate = 130;
const int stat_Copy_PushedInputNewFrame = 131;
const int stat_Copy_PushedInputMultiNewFrame = 132;
const int stat_Copy_PushFrameWithInputs = 133;
const int stat_Copy_ListDuplicate = 134;
const int stat_Copy_LoopCopyRebound = 135;
const int stat_Cast_ListCastElement = 136;
const int stat_Cast_PushFrameWithInputs = 137;
const int stat_Cast_FinishFrame = 138;
const int stat_Touch_ListCast = 139;
const int stat_ValueCreates = 140;
const int stat_ValueCopies = 141;
const int stat_ValueCast = 142;
const int stat_ValueCastDispatched = 143;
const int stat_ValueTouch = 144;
const int stat_ListsCreated = 145;
const int stat_ListsGrown = 146;
const int stat_ListSoftCopy = 147;
const int stat_ListHardCopy = 148;
const int stat_DictHardCopy = 149;
const int stat_StringCreate = 150;
const int stat_StringDuplicate = 151;
const int stat_StringResizeInPlace = 152;
const int stat_StringResizeCreate = 153;
const int stat_StringSoftCopy = 154;
const int stat_StringToStd = 155;
const int stat_StepInterpreter = 156;
const int stat_InterpreterCastOutputFromFinishedFrame = 157;
const int stat_BranchNameLookups = 158;
const int stat_PushFrame = 159;
const int stat_LoopFinishIteration = 160;
const int stat_LoopWriteOutput = 161;
const int stat_WriteTermBytecode = 162;
const int stat_DynamicCall = 163;
const int stat_FinishDynamicCall = 164;
const int stat_DynamicMethodCall = 165;
const int stat_SetIndex = 166;
const int stat_SetField = 167;
const int name_LastStatIndex = 168;
const int name_LastBuiltinName = 169;
