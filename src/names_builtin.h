...
const int stat_StepInterpreter = 144;
const int stat_InterpreterCastOutputFromFinishedFrame = 145;
const int stat_BranchNameLookups = 146;
const int stat_FramesCreated = 147;
const int stat_LoopFinishIteration = 148;
const int stat_GetTermEvalMetadata = 149;
const int stat_DynamicCall = 150;
const int stat_SetIndex = 151;
const int stat_SetField = 152;
const int name_LastStatIndex = 153;
const int name_LastBuiltinName = 154;
