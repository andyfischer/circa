...
const int stat_StringDuplicate = 143;
const int stat_StringResizeInPlace = 144;
const int stat_StringResizeCreate = 145;
const int stat_StringSoftCopy = 146;
const int stat_StringToStd = 147;
const int stat_StepInterpreter = 148;
const int stat_InterpreterCastOutputFromFinishedFrame = 149;
const int stat_BranchNameLookups = 150;
const int stat_FramesCreated = 151;
const int stat_LoopFinishIteration = 152;
const int stat_GetTermEvalMetadata = 153;
const int stat_DynamicCall = 154;
const int stat_SetIndex = 155;
const int stat_SetField = 156;
const int name_LastStatIndex = 157;
const int name_LastBuiltinName = 158;
