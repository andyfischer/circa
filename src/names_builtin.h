...
const int op_FireNative = 171;
const int op_CaseBlock = 172;
const int op_ForLoop = 173;
const int op_ExitPoint = 174;
const int op_Return = 175;
const int op_Continue = 176;
const int op_Break = 177;
const int op_Discard = 178;
const int op_FinishFrame = 179;
const int op_FinishLoop = 180;
const int op_ErrorNotEnoughInputs = 181;
const int op_ErrorTooManyInputs = 182;
const int sym_LoopProduceOutput = 183;
const int sym_FlatOutputs = 184;
const int sym_OutputsToList = 185;
const int sym_Multiple = 186;
const int sym_Cast = 187;
const int sym_DynamicMethodOutput = 188;
const int sym_FirstStatIndex = 189;
const int stat_TermsCreated = 190;
const int stat_TermPropAdded = 191;
const int stat_TermPropAccess = 192;
const int stat_InternedNameLookup = 193;
const int stat_InternedNameCreate = 194;
const int stat_Copy_PushedInputNewFrame = 195;
const int stat_Copy_PushedInputMultiNewFrame = 196;
const int stat_Copy_PushFrameWithInputs = 197;
const int stat_Copy_ListDuplicate = 198;
const int stat_Copy_LoopCopyRebound = 199;
const int stat_Cast_ListCastElement = 200;
const int stat_Cast_PushFrameWithInputs = 201;
const int stat_Cast_FinishFrame = 202;
const int stat_Touch_ListCast = 203;
const int stat_ValueCreates = 204;
const int stat_ValueCopies = 205;
const int stat_ValueCast = 206;
const int stat_ValueCastDispatched = 207;
const int stat_ValueTouch = 208;
const int stat_ListsCreated = 209;
const int stat_ListsGrown = 210;
const int stat_ListSoftCopy = 211;
const int stat_ListHardCopy = 212;
const int stat_DictHardCopy = 213;
const int stat_StringCreate = 214;
const int stat_StringDuplicate = 215;
const int stat_StringResizeInPlace = 216;
const int stat_StringResizeCreate = 217;
const int stat_StringSoftCopy = 218;
const int stat_StringToStd = 219;
const int stat_StepInterpreter = 220;
const int stat_InterpreterCastOutputFromFinishedFrame = 221;
const int stat_BlockNameLookups = 222;
const int stat_PushFrame = 223;
const int stat_LoopFinishIteration = 224;
const int stat_LoopWriteOutput = 225;
const int stat_WriteTermBytecode = 226;
const int stat_DynamicCall = 227;
const int stat_FinishDynamicCall = 228;
const int stat_DynamicMethodCall = 229;
const int stat_SetIndex = 230;
const int stat_SetField = 231;
const int sym_LastStatIndex = 232;
const int sym_LastBuiltinName = 233;
