...
#define NUM_INPUTS (_caller->numInputInstructions())
...
#define OUTPUT (get_output(_context, _caller, 0))
#define EXTRA_OUTPUT(index) (get_extra_output(_context, _caller, (index)))
