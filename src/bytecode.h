...
const char bc_DynamicMethodCall = 0x12;
const char bc_FuncCall = 0x13;
const char bc_FuncApply = 0x14;
const char bc_PushCase = 0x16;
const char bc_ForLoop = 0x17;

// Pushing inputs to a new frame.
const char bc_PushInputFromStack = 0x22;
const char bc_PushVarargList = 0x20;
const char bc_PushInputFromClosure = 0x21;
const char bc_PushInputFromApplyList = 0x23;
