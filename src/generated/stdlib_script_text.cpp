...
const char* STDLIB_CA_TEXT = 
    ...
    "def Closure.apply(self, List inputs) -> any\n"
    "\n"
    "-- Builtin functions\n"
    ...
    "\n"
    "def declared_state(state any val, Type t, Closure initializer :optional) -> any\n"
    "    if val != null\n"
    "        -- Try to cast to the desired type\n"
    "        val, cast_success = cast(val, t)\n"
    "\n"
    "        if cast_success\n"
    "            return val\n"
    "\n"
    ...
    "\n"
    "\n"
    "def Block.to_closure(self) -> Closure\n"
    "    Closure([self, []])\n"
    "-- Language defect: Functions and closures should be stored with same data type.\n"
    "def Function.to_closure(self) -> Closure\n"
    "    self.block.to_closure\n"
    "\n"
    ...
    "    self.top_frame.current_term\n"
    "def Stack.dump(self)\n"
    "    -- Dumps a string representation to stdout.\n"
    "def Stack.find_active_frame_for_term(self, Term term) -> Frame\n"
    "def Stack.inject(self, String name, any val) -> bool\n"
    "    -- Inject a value into the stack's state. Must correspond to an existing state definition.\n"
    ...
    "def Stack.push_frame(self, Block b, List inputs)\n"
    "    -- Push a new frame, using the given block and input list.\n"
    "def Stack.pop_frame(self)\n"
    ...
    "    -- Create a new stack\n"
    "def make_stack2(Closure closure) -> Stack\n"
    "    stack = make_stack()\n"
    "    stack.push_frame(closure.block, [])\n"
    "    stack\n"
    "\n"
    "-- Actors\n"
    "type Actor {\n"
    ...
    "\n"
    "    _state = self.stateVal.get\n"
    "    out = self.func.apply(inputs, state = _state)\n"
    "    self.stateVal.set(_state)\n"
    "    return out\n"
    "    \n"
    ...
    "def Map.map_element(@self, any key, Closure func)\n"
