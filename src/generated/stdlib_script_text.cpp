...
const char* STDLIB_CA_TEXT = 
    ...
    "\n"
    "-- Internally used bytecode-level operations (our version of ASM)\n"
    "def _bc_push_block_dynamic(Block block)\n"
    "def _bc_enter_frame()\n"
    "def _bc_pop_as_module()\n"
    "def _bc_pop_frame()\n"
    "\n"
    "-- Modules\n"
    "\n"
    ...
    "\n"
    "def require(String moduleName) -> Module\n"
    "    -- Load a module, and use it during name lookup.\n"
    "    -- TODO: This call should be memoized.\n"
    "    \n"
    "    block = load_module(moduleName)\n"
    "    if block.is_null\n"
    "      return Map.make\n"
    "\n"
    "    _bc_push_block_dynamic(block)\n"
    "    _bc_enter_frame()\n"
    "    result = _bc_pop_as_module()\n"
    "    _bc_pop_frame()\n"
    "    result\n"
    "\n"
