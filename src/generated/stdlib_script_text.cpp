...
const char* STDLIB_CA_TEXT = 
    ...
    "\n"
    "def declared_state(state any val, Type t, Func initializer :optional) -> any\n"
    "    if val != null\n"
    ...
    "def Stack.push_frame2(self, Func func)\n"
    "    self.push_frame(func.block, [])\n"
    ...
    "    -- Create a new stack\n"
    "def make_stack2(Func func) -> Stack\n"
    "    stack = make_stack()\n"
    "    stack.push_frame(func.block, [])\n"
    "    stack\n"
    "\n"
    "-- Actors\n"
    "type Actor {\n"
    ...
    "}\n"
    "\n"
    "def make_actor(Func func) -> Actor\n"
    "    actor = make(Actor)\n"
    "    actor.func = func\n"
    "    actor\n"
    "\n"
