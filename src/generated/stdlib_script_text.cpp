// This file was autogenerated from: ['src/ca/stdlib.ca', 'src/ca/code_change.ca']
...
const char* STDLIB_CA_TEXT = 
    ...
    "    left.div(right)\n"
    "\n"
    "def number.add(left, right)\n"
    "  add(left, right)\n"
    "def number.sub(left, right)\n"
    "  sub(left, right)\n"
    "def number.mult(left, right)\n"
    "  mult(left, right)\n"
    "def number.div(left, right)\n"
    "  div(left, right)\n"
    "\n"
    "-- Misc builtin funcs --\n"
    "\n"
