...
const char* STDLIB_CA_TEXT = 
    ...
    "def Actor.inject_context(self, Symbol name, any val)\n"
    "def Actor.call(self, any inputs :multiple) -> any\n"
    "    -- Synchronous actor call\n"
    "def Actor.apply(self, List inputs) -> any\n"
    "    -- Synchronous actor call (with inputs as a list)\n"
    "def Actor.push_frame(self, Block b, List inputs)\n"
    "    -- Push a new frame, using the given block and input list.\n"
    "def Actor.pop_frame(self)\n"
    "    -- Pop the topmost frame.\n"
    "def Actor.set_state_input(self, any val)\n"
    "    -- Assign a value to the :state input of the topmost frame (if any)\n"
    "def Actor.get_state_output(self) -> any\n"
    "def Actor.reset(self)\n"
    "    -- Clear this interpreter's state, including stack frames.\n"
    "def Actor.restart(self)\n"
