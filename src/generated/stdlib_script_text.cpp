...
const char* STDLIB_CA_TEXT = 
    ...
    "def List.append(@self, any element) -> int\n"
    "    -- Append an element to the end of this list, return the new element's index.\n"
    "def List.append_style2(self, any item) -> List\n"
    ...
    "def List.resize_style2(self, int length) -> List\n"
    "    -- Resize the list to have the given length. If the length is increased, then\n"
    "    -- null values are appended on the right; if the length is decreased then\n"
    "    -- existing values on the right are dropped.\n"
    ...
    "\n"
    "def List.insert(@self, int index, any val)\n"
    ...
    "def Map.insertPairs(@self, List pairs)\n"
