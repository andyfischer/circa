...
const char* BUILTIN_MODULE_stdlib = 
    ...
    "  -- Return a flattened list; if any nested elements are lists then they'll all be\n"
...
const char* BUILTIN_MODULE_source_repro = 
    ...
    "}\n"
    "\n"
    "def Phrase.toString(self) -> String\n"
