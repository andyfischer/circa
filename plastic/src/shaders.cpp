...
{
    std::string vertText = circa::storage::read_text_file(app::find_asset_file(vertFilename));
    std::string fragText = circa::storage::read_text_file(app::find_asset_file(fragFilename));
